...
L["%d or %d"] = "%d ou %d"
L["'%s' - expected 'on' or 'off', or no argument to toggle."] = "'%s' -  'on' ou 'off' ou vide pour activer."
L["'%s' - expected 'on', 'off' or 'default', or no argument to toggle."] = "'%s' -  'on' ou 'off' ou 'default' ou vide pour activer."
L["'%s' - expected 'RRGGBB' or 'r g b'."] = "'%s' - 'RRGGBB' ou 'r g b' attendu."
L["'%s' - expected 'RRGGBBAA' or 'r g b a'."] = "'%s' - 'RRGGBBAA' ou 'r g b a' attendu."
L["'%s' - Invalid Keybinding."] = "'%s' - Raccourcis invalide."
L["'%s' - values must all be either in the range 0..1 or 0..255."] = "'%s' - valeurs comprises entre 0..1 ou 0..255."
L["'%s' - values must all be either in the range 0-1 or 0-255."] = "'%s' - valeurs comprises entre 0-1 ou 0-255."
L["'%s' '%s' - expected 'on' or 'off', or no argument to toggle."] = "'%s' '%s' - 'on' ou 'off' ou vide pour activer."
L["'%s' '%s' - expected 'on', 'off' or 'default', or no argument to toggle."] = "'%s' '%s' -  'on' ou 'off' ou 'default' ou vide pour activer."
...
L["A new tier is here!  You should probably reset or rescale GP (Interface -> Options -> AddOns -> EPGP)!"] = "Un nouveau Tier est là! Vous devriez réinitialiser ou recalibrer les GP (Interface -> Options -> AddOns -> EPGP)!"
L["Alts"] = "Rerolls"
...
L["Custom announce channel name"] = "Canal de l'annonce personnalisé"
L["Decay"] = "Réduction"
L["Decay EP and GP by %d%%?"] = "Réduire les EP et les GP de %d%% ?"
...
L["GP (not EP) is reset"] = "GP (pas les EP) réinitialisé"
L["GP (not ep) reset"] = "réinitialiser GP (pas les EP)"
L["GP is rescaled for the new tier"] = "les GP ont été recalibré pour le nouveau Tier"
L["GP on tooltips"] = "GP sur les infos (tooltip)"
L["GP Reason"] = "Raison du GP"
L["GP rescale for new tier"] = "réinitialiser les GP pour le nouveau Tier"
L["GP: %d"] = true
...
L["must be equal to or higher than %s"] = "doit être supérieur ou égale à %s"
L["must be equal to or lower than %s"] = "doit être inférieur ou égale à %s"
L["Next award in "] = "Prochain gain dans"
--Translation missing 
-- L["off"] = ""
--Translation missing 
-- L["on"] = ""
L["Only display GP values for items at or above this quality."] = "Afficher les GP uniquement pour les objets de cette qualité ou meilleur."
...
L["Redo"] = "Refaire"
L["Re-scale all main toons' GP to current tier?"] = "Recalibrer les GP de tous les main pour le nouveau Tier"
...
L["Resets GP (not EP!) of all members of the guild. This will set all main toons' GP to 0. Use with care!"] = "Réinitialise les GP (pas les EP!) de tous les membres de la guilde. Cela va remettre tous les main à 0 GP. A utiliser avec précaution."
...
L["Some english word that doesn't exist"] = "Quelques mots d'anglais qui n'existe pas"
