...
function LootMaster:InitUI()
    ...
    local frame = CreateFrame("Frame","LootMasterUIFrame",UIParent, BackdropTemplateMixin and "BackdropTemplate")
...
function LootMaster:CreateLootSelectFrame()
    ...
    local frame = CreateFrame("Frame", nil, self.frame, BackdropTemplateMixin and "BackdropTemplate")
    --#region Setup main masterlooter frame
    frame:Show()
    ...
    local timerFrame = CreateFrame("Frame", nil, frame, BackdropTemplateMixin and "BackdropTemplate")
    ...
    local timerBorderFrame = CreateFrame("Frame", nil, timerFrame, BackdropTemplateMixin and "BackdropTemplate")
    ...
    --[[ NOTE EDITBOX ]]--
    local tbNote = CreateFrame("EditBox", nil, frame, BackdropTemplateMixin and "BackdropTemplate")
