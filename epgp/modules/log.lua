...
local function GetTimestamp(diff)
  timestamp_t.month = C_DateAndTime.GetCurrentCalendarTime().month
  timestamp_t.day = C_DateAndTime.GetCurrentCalendarTime().monthDay
  timestamp_t.year = C_DateAndTime.GetCurrentCalendarTime().year
