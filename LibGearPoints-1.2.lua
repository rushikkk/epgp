...
local ITEM_BONUS_GP = {
  ...
  [523] = 100, -- extra socket
  [563] = 100, -- extra socket
  [564] = 100, -- extra socket
  [565] = 100, -- extra socket
  [572] = 100, -- extra socket
  [1808] = 100, -- extra socket
  [6935] = 100, -- extra socket
}
...
function lib:GetValue(item)
  ...
  -- for these).
  if level < 60 and not CUSTOM_ITEM_DATA[itemID] then
